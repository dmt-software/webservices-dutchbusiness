...
class DossierV2
{
     ...
     * @return DateV2
     */
    public function getPersonnelReferenceDate(): ?DateV2
    {
        return $this->personnelReferenceDate;
    }

    /**
     * @param DateV2 $personnelReferenceDate
     */
    public function setPersonnelReferenceDate(DateV2 $personnelReferenceDate): void
    {
     ...
     * @return DateV2
     */
    public function getPersonnelCiReferenceDate(): ?DateV2
    {
        return $this->personnelCiReferenceDate;
    }

    /**
     * @param DateV2 $personnelCiReferenceDate
     */
    public function setPersonnelCiReferenceDate(DateV2 $personnelCiReferenceDate): void
    {
     ...
     * @return DateV2
     */
    public function getContinuationDate(): ?DateV2
    {
        return $this->continuationDate;
    }

    /**
     * @param DateV2 $continuationDate
     */
    public function setContinuationDate(DateV2 $continuationDate): void
    {
