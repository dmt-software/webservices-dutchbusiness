...
/**
 * Class UpdateRemoveDossierRequest
 *
 * Remove a dossier from the list of dossiers for which the user (the user whose credentials are used to make the call)
 * wants to receive updates.
 *
 * @JMS\AccessType("public_method")
 */
class UpdateRemoveDossierRequest implements RequestInterface
{
